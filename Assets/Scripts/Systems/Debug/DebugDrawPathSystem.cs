            ...
            for (var i = 0; i < pathes.Length; i++)
            {
                ...
                if (!path.InProgress && path.Reachable)
                {
                    ...
                    foreach (PathNode nodeLink in buffer)
                    {
                        ...
                        Debug.DrawLine(new Vector3(x - 0.15f, y + 0.15f, -1.1f),
                            new Vector3(x + 0.15f, y - 0.15f, -1.1f), Color.cyan);
                    ...
                    for (var index = 0;
                        index < Mathf.Clamp(PathfindingTest.DebugNodeIndexValue, 0, debugBuffer.Length);
                        index++)
                    {
                        ...
                        Debug.DrawLine(new Vector3(x - 0.1f, y + 0.1f, -1.1f), new Vector3(x + 0.1f, y - 0.1f, -1.1f),
                            Color.magenta);

                        Debug.DrawLine(new Vector3(x + 0.1f, y + 0.1f, -1.1f), new Vector3(x - 0.1f, y - 0.1f, -1.1f),
                            Color.magenta);

                        Debug.DrawLine(new Vector3(x + 0.1f, y + 0.1f, -1.1f), new Vector3(px - 0.1f, py - 0.1f, -1.1f),
                            Color.magenta);
                    }
                }
